...
devcontainer up \
  ...
  --additional-features='{"ghcr.io/eigenmannmartin/devcontainer-features/neovim:0": {"version":"nightly"}, "ghcr.io/eigenmannmartin/devcontainer-features/xdg-open:0": {}, "ghcr.io/eigenmannmartin/devcontainer-features/neovim-essentials:0": {}, "ghcr.io/devcontainers/features/sshd:1": {}}' $@
